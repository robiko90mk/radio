...
enum displayRequestType_e { BOOTSTRING, NEWMODE, CLOCK, NEWTITLE, NEWSTATION, NEXTSTATION, DRAWPLAYLIST, CLOSEPLAYLIST, DRAWVOL, DBITRATE, AUDIOINFO, SHOWVUMETER, DSPRSSI, SHOWWEATHER, NEWWEATHER, NEWWEATHERICON, PSTOP, PSTART, DSP_START, WAITFORSD, SDFILEINDEX, NEWIP, DSP_RECONF, STATUS_SPEECH, STATUS_BLFADE, STATUS_LSTRIP, NOPE };
